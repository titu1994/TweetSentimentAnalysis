...
def write_predictions(model_dir='conv/', mode='train', dataset='full'):
    ...
    if mode == 'train':
        ...
        preds_save_path = save_dir + "/" + model_dir + "conv_predictions.npy"
        np.save(preds_save_path, model_predictions)


def calculate_score(model_dir='conv/', base_dir='test/', dataset='full'):
