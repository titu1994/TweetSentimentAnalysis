...
checkpoint = ModelCheckpoint('models/conv_model (glove 300).h5', monitor='val_fbeta_score', verbose=2, save_weights_only=True,
...
#x = MaxPooling1D(3)(x)
#x = Conv1D(512, 5, activation='relu', border_mode='same', init='he_uniform')(x)
...
model.load_weights('models/conv_model (glove 300).h5')
